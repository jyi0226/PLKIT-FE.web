/*
커뮤니티와 마켓 관련 API 요청을 관리
CRUD(생성, 조회, 수정, 삭제) 작업을 수행하며, 백엔드와의 통신을 통해 데이터를 관리
JWT 토큰 인증을 추가하여 보안성을 확보하며, 로컬 저장소를 이용해 일부 데이터를 캐싱함
*/

import mock from "./mock.json"; //모의 데이터 파일
